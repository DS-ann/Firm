...
void updateLEDs(){
  ...
  digitalWrite(LED_WIFI,(state==WIFI_START || wifiScanStarted || wifiConnecting)?blinkState:(state==WIFI_MODE?(WiFi.status()!=WL_CONNECTED?blinkState:HIGH):LOW));
...
void runStateMachine(){
  ...
  // Check scan result
  if(wifiScanStarted && !wifiConnecting){
