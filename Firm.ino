...
// ===== WiFi =====
#define NUM_WIFI 4
const char* ssidList[NUM_WIFI] = {"Lenovo","vivo Y15s","POCO5956","MiNet"};
const char* passwordList[NUM_WIFI] = {"debarghya","Debarghya1234","debarghya","pass3"};
...
void setup(){
  ...
  xTaskCreatePinnedToCore(BTTask,"BTTask",4096,NULL,1,NULL,1); // Core 1 for Bluetooth
}
