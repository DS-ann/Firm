...
uint16_t connectedClients[MAX_BLE_CLIENTS] = {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
...
// Shift array
        ...
        // Mark the last shifted slot as invalid
        connectedClients[clientCount - 1] = INVALID_CONN_HANDLE; 
...
void stopBLE(){
  ...
  for(int i=0;i<MAX_BLE_CLIENTS;i++){
      connectedClients[i] = INVALID_CONN_HANDLE;
  }
...
void processBLEQueue(){
  ...
  // Notify all subscribed clients automatically
